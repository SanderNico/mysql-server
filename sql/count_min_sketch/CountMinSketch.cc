...
std::map<std::pair<std::string, std::string>, CountMinSketch, std::less<std::pair<std::string, std::string>>, Malloc_allocator<const std::pair<std::pair<std::string, std::string>, CountMinSketch>>(key_memory_count_min_sketch)> Dictionary;