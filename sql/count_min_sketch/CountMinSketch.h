...
extern std::map<std::pair<std::string, std::string>, CountMinSketch, std::less<std::pair<std::string, std::string>>, Malloc_allocator<std::pair<const std::pair<std::string, std::string>, CountMinSketch>>> Dictionary;
